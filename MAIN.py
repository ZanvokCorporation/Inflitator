#This is the MAIN script of Infiltrator. This is where the main loop is located and this is where all resources are loaded.
...
class Canvas:
    ...
    def __init__(self, width, height):
        ...
        pygame.display.set_caption("INFLITATOR")
...
##                print(b/len(allfps))
        ...
        try:
            ...
            menuController.save_settings()
            calculate_statistics()
            logging.warning("INFLITATOR has crashed. Please send this report to Zanvok Corporation.")
...
if __name__ == '__main__':
    ...
    beta = TEXT.Text(5,5,"INFLITATOR  BETA  BUILD  V. 1.3", SETTINGS.WHITE, "DUGAFONT.ttf", 20)
