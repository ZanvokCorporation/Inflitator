...
class CreditsMenu(Menu):
    ...
    def __init__(self):
        ...
        self.maxwellsalmon = TEXT.Text(0,0, 'ZANVOK  CORPORATION', SETTINGS.DARKGRAY, "DUGAFONT.ttf", 38)
        ...
        self.eli = TEXT.Text(0,0, 'DOOM  BOBBY PRINCE', SETTINGS.DARKGRAY, "DUGAFONT.ttf", 30)
        self.eli.update_pos((SETTINGS.canvas_actual_width/2)-(self.eli.layout.get_width()/2)+8, 240)

        #Maps
        self.contributions = TEXT.Text(0,0, 'DEVELOPERS', SETTINGS.LIGHTGRAY, "DUGAFONT.ttf", 20)
        self.contributions.update_pos((SETTINGS.canvas_actual_width/2)-(self.contributions.layout.get_width()/2)+8, 290)

        self.contributors = TEXT.Text(0,0, 'GAUTHAM  NAIR,  SURAJ  VARMA,  ADITHYA  VIJAYAN,  MAXWELLSALMON  ' , SETTINGS.DARKGRAY, "DUGAFONT.ttf", 20)
        self.contributors.update_pos((SETTINGS.canvas_actual_width/2)-(self.contributors.layout.get_width()/2)+8, 320)
        self.contributors2 =  TEXT.Text(0,0, ' ' , SETTINGS.DARKGRAY, "DUGAFONT.ttf", 20)
...
class SupportSplash:
    ...
    def __init__(self):
        ...
        self.pleas = ['You  have  been  playing  INFLITATOR', 'for  over  two  hours  now.  We', 'really  hope  you  enjoy  it']
        self.texts = []
